...
JAZZMIN_SETTINGS = {
    ...
    "custom_links": {
        ...
        "configurations": [
            ...
            },
            {
                ...
                "url": "types_documents",
                # "icon": "fa fa-times",
                "permissions": ["configurations.view_types_documents"],
            },
            {
                "name": "Mouvements",
                "url": "mouvements",
                # "icon": "fa fa-times",
                "permissions": ["configurations.view_mouvements"],
            },
            {
                "name": "Motifs",
                "url": "motifs",
                # "icon": "fa fa-times",
                "permissions": ["configurations.view_motifs"],
            },
            {
                "name": "Secteurs d'activité",
                "url": "secteur_activite",
                # "icon": "fa fa-times",
                "permissions": ["configurations.view_secteuractivite"],
            },
            #{
    ...
    "icons": {
        ...
        "analysecontrole": "fas fa-chart-bar",
